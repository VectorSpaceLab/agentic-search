...
| Model         | BGE-Reasone-Reranker-0821-\*   | -                                                            | -            | used in BGE-Reasoner-0821; will not be released due to their suboptimal performance compared to BGE-Reasoner-Reranker-0923-\* |
...
| Search Results     | search results of BGE-Reasoner-Embed-0923 on BRIGHT          | [🤗](https://huggingface.co/hanhainebula/reason-embed-basic-qwen3-8b-0928/tree/main/search_results/examples) (same as [🤗](https://huggingface.co/BAAI/bge-reasoner-embed-qwen3-8b-0923/tree/main/search_results)) | Sep 23, 2025 | nDCG@10 = 37.1 using original query                          |
| Search Results     | search results of BM25 on BRIGHT                             | [🤗 (TBA)]()                                                  | Oct 11, 2025 | nDCG@10 = 30.5 using BGE-Reasoner-Rewritten-Query-0821       |
| Search Results     | search results of BGE-Reasoner-Embed-0923 on BRIGHT          | [🤗 (TBA)]()                                                  | Oct 11, 2025 | nDCG@10 = 40.3 using BGE-Reasoner-Rewritten-Query-0821       |
